			...
			<div class="full-area">
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-8 col-xs-12">
                        ...
                        <div class="col-sm-3 col-md-3 col-xs-12 logo-area">
							<div class="hvr-bob"> <img src="images/descriptive-logo.png" /></div>
							<div class="line-effect"> <a href="showCandidateProfile"> Candidate <br /> Profile </a></div>
						</div>
					</div>
					<div class="col-sm-12 col-md-2 col-xs-12"> </div>
				</div>
			</div>
			<div align="right"><a href="cLogout" STYLE="color: #FFFFFF;"><b>Logout</b></a></div>	
			<div align="right"><a href="clearExamInfo" STYLE="color: red;"><b>Clear Exam Report</b></a></div>		 
		</div>
